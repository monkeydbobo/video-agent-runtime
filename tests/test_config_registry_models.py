...
class TestProviderRegistry:
    # vidu / atlascloud / streamlake 仅图片或视频，kling 为仅身份注册（无 models），均跳过文本相关断言
    _TEXT_PROVIDERS = [pid for pid in PROVIDER_REGISTRY if pid not in ("vidu", "atlascloud", "streamlake", "kling")]
