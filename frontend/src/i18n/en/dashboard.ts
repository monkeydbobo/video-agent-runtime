...
export default {
  ...
  'content_mode_marketing_desc': 'Product ads — product three-views and lifestyle scenes drive vertical ad units for e-commerce and brand campaigns.',
  'marketing_visuals_mode': 'Marketing video',
  'welcome_idle_desc_marketing': 'Drag or upload a product brief or ad script (txt/md). AI will extract products and scene settings.',
  'welcome_has_sources_desc_marketing': 'Brief ready. Add more files or start AI analysis below.',
  'analyzing_content_desc_marketing': 'AI is analyzing the product brief — extracting products, scenes, accessories, and campaign overview...',
  'workspace_nav_products': 'Products',
  'workspace_nav_accessories': 'Accessories',
  'optional': 'Optional',
  'creating': 'Creating...',
  ...
  'ad_units_split_complete_label': 'Ad unit outline complete',
