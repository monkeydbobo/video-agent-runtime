...
export default {
  ...
  'api_keys': 'API Keys',
  'about': 'About',
  'system_config_title': 'Account settings and API access',
  'user_settings_scope_hint': 'These settings apply only to your signed-in account and are not shared with other users.',
  ...
  'model_selection_desc': 'Set your default generation models; new projects can override them individually.',
