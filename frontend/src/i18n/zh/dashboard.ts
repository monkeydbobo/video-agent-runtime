...
export default {
  ...
  'content_mode_marketing_desc': '产品广告——从产品三视图与场景图生成竖屏广告镜头，适合电商/品牌短视频。',
  'marketing_visuals_mode': '营销视频模式',
  'welcome_idle_desc_marketing': '请拖拽或上传产品简报/广告脚本（txt/md），AI 将提取产品与场景设定。',
  'welcome_has_sources_desc_marketing': '简报已就绪。您可以继续添加文件，或点击下方按钮开始 AI 分析。',
  'analyzing_content_desc_marketing': 'AI 正在分析产品简报，提取产品、场景、配件与 campaign 概述...',
  'workspace_nav_products': '产品',
  'workspace_nav_accessories': '配件',
  'optional': '可选',
  'creating': '创建中...',
  ...
  'ad_units_split_complete_label': '广告镜头大纲已完成',
