...
export default {
  ...
  'reference_video_upload_failed_hint': 'Tải video tham chiếu viral thất bại, bạn có thể tải lại ở trang Tệp gốc',
  ...
  'marketing_video': 'Video marketing',
  'content_mode_marketing_desc': 'Quảng cáo sản phẩm — ba góc nhìn sản phẩm và bối cảnh tạo các unit quảng cáo dọc cho thương mại điện tử và thương hiệu.',
  'marketing_visuals_mode': 'Video marketing',
  'welcome_idle_desc_marketing': 'Kéo thả hoặc tải brief sản phẩm / kịch bản quảng cáo (txt/md). AI sẽ trích xuất sản phẩm và bối cảnh.',
  'welcome_has_sources_desc_marketing': 'Brief đã sẵn sàng. Thêm tệp hoặc bắt đầu phân tích AI bên dưới.',
  'analyzing_content_desc_marketing': 'AI đang phân tích brief — trích xuất sản phẩm, cảnh, phụ kiện và tổng quan chiến dịch...',
  'workspace_nav_products': 'Sản phẩm',
  'workspace_nav_accessories': 'Phụ kiện',
  'optional': 'Tùy chọn',
  'creating': 'Đang tạo...',
  ...
  'output_files': 'Video hoàn chỉnh',
  'reference_videos': 'Video tham chiếu viral',
  'upload_source_files': 'Tải lên tệp gốc',
  'upload_reference_video': 'Tải video viral',
  'replace_reference_video': 'Thay video viral',
  ...
  'ad_units_split_complete_label': 'Đã hoàn tất dàn ý unit quảng cáo',
  ...
  'reference_video_uploaded': 'Đã tải video tham chiếu viral',
