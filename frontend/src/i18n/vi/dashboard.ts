...
export default {
  ...
  'api_keys': 'Khóa API',
  'about': 'Giới thiệu',
  'system_config_title': 'Cấu hình tài khoản và truy cập API',
  'user_settings_scope_hint': 'Các cài đặt này chỉ áp dụng cho tài khoản đang đăng nhập, không chia sẻ với người dùng khác.',
  ...
  'model_selection_desc': 'Đặt mô hình mặc định của bạn; dự án mới có thể ghi đè riêng.',
  ...
  'tool_name_compose_video': 'Ghép video',
