  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div
        ...
        className="flex items-center gap-0.5 border-b border-[var(--color-hairline)] bg-[oklch(0.976_0.009_250_/_0.73)] px-5"
      >
        <button
          type="button"
          role="tab"
      ...
      {tab === "preproc" ? (
        <div className="min-h-0 flex-1 overflow-auto bg-[oklch(0.981_0.008_250_/_0.59)]">
        ...
        <div
          ref={workbenchRef}
          className="relative min-h-0 flex-1 overflow-hidden bg-[oklch(0.981_0.008_250_/_0.59)]"
        >
          <div className="grid h-full min-h-0" style={{ gridTemplateColumns: gridCols }}>
            ...
            <div className="flex min-h-0 flex-col overflow-hidden bg-[radial-gradient(ellipse_at_top,oklch(0.970_0.009_270_/_0.64),oklch(0.987_0.008_265_/_0.56))]">
              {selected ? (
                <>
                  <div className="flex flex-wrap items-center gap-2 border-b border-[var(--color-hairline-soft)] px-4 py-2.5">
                    <span
                      translate="no"
                      className="rounded px-2.5 py-1 font-mono text-xs font-bold tracking-wider text-[oklch(0.99_0_0)] [background:linear-gradient(180deg,var(--color-accent-2),var(--color-accent))] shadow-[inset_0_1px_0_oklch(1_0_0_/_0.35),0_2px_6px_-2px_var(--color-accent-glow)]"
                    >
                      {selected.unit_id}
                    </span>
                    <span className="inline-flex items-center gap-1 rounded border border-[var(--color-hairline-soft)] bg-[oklch(0.959_0.008_265_/_0.78)] px-2 py-0.5 text-[11.5px] text-[var(--color-text-2)]">
                    ...
                    <button
                      ...
                      className="focus-ring inline-grid h-6 w-6 place-items-center rounded border border-[var(--color-hairline)] bg-[oklch(0.959_0.008_265_/_0.73)] text-[var(--color-text-2)] hover:bg-[oklch(0.937_0.009_265_/_0.83)] disabled:cursor-not-allowed disabled:opacity-50"
                    >
                  ...
                  {stackPreview && (
                    <div
                      ...
                      className="flex items-center gap-0 border-b border-[var(--color-hairline)] bg-[oklch(0.976_0.009_250_/_0.67)] px-5"
                    >
                      <button
                        type="button"
                        role="tab"
                  ...
                  <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
                    {(!stackPreview || stackTab === "editor") && (
                      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
                        ...
                        {/* Editor bottom bar */}
                        <div className="flex flex-shrink-0 items-center gap-2 border-t border-[var(--color-hairline-soft)] bg-[oklch(0.981_0.008_265_/_0.73)] px-3.5 py-2">
                          <span
                          ...
                          <button
                            ...
                            className={`focus-ring inline-flex min-w-[80px] items-center justify-center gap-1.5 rounded-md px-3 py-1 text-xs font-semibold ${
                              isDirty
                                ? "text-[oklch(0.99_0_0)] [background:linear-gradient(180deg,var(--color-accent-2),var(--color-accent))] shadow-[inset_0_1px_0_oklch(1_0_0_/_0.35),0_4px_12px_-4px_var(--color-accent-glow)]"
                                : "border border-[var(--color-hairline)] bg-[oklch(0.959_0.008_265_/_0.73)] text-[var(--color-text-4)]"
                    ...
                    {stackPreview && stackTab === "preview" && (
                      <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-[linear-gradient(180deg,oklch(0.976_0.008_265_/_0.73),oklch(0.987_0.008_265_/_0.64))]">
                        <UnitPreviewPanel
                          unit={selected}
                          projectName={projectName}
            ...
            {!stackPreview && (
              <div className="flex min-h-0 flex-col overflow-hidden border-l border-[var(--color-hairline)] bg-[linear-gradient(180deg,oklch(0.976_0.008_265_/_0.73),oklch(0.987_0.008_265_/_0.64))]">
                <UnitPreviewPanel
                  unit={selected}
                  projectName={projectName}
          ...
          {listFlyoutOpen && (
            <>
              ...
              />
              <div
                className="absolute bottom-0 left-0 top-0 z-40 w-[320px] shadow-[8px_0_24px_-8px_oklch(0.30_0.04_265_/_0.16)]"
              >
                <UnitList
                  units={units}
                  selectedId={selectedUnitId}
