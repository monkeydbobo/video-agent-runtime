...
export function EpisodeHeader({ episode, title, units, onSaveTitle, canEditTitle }: EpisodeHeaderProps) {
  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-5 border-b border-[var(--color-hairline)] bg-[linear-gradient(180deg,oklch(0.959_0.010_290_/_0.67),oklch(0.970_0.009_250_/_0.55))] px-6 py-4">
